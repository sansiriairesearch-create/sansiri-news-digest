...
| **BR-10 — ลิงก์เวอร์ชันเว็บท้ายอีเมล (สำหรับตรวจสอบ)** | อัปโหลดไฟล์ standalone HTML ขึ้น **Google Drive** แล้วแปะ **ลิงก์ไว้ท้ายสุดของอีเมล** ("เปิดเวอร์ชันเว็บ (คลิกลิงก์ข่าวได้โดยตรง สำหรับตรวจสอบ)") ผ่าน `build_html_digest.py --web-link <URL>`. ผู้ตรวจเปิดลิงก์เพื่อคลิกข่าวแบบตรง (ไม่ผ่าน Gmail wrapper). **ข้อจำกัด:** Drive MCP ตั้งสิทธิ์ public อัตโนมัติไม่ได้ → ลิงก์เปิดได้เฉพาะ **เจ้าของบัญชี** (ผู้ตรวจ); ถ้าต้องการให้ผู้รับทุกคนเปิดได้ ต้องโฮสต์แบบ public (เช่น GitHub Pages) |
