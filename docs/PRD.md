...
| **BR-09 — แนบไฟล์ HTML ของ digest** | นอกจากเนื้ออีเมล HTML แล้ว ให้ **แนบไฟล์ `Sansiri-News-<YYYY-MM-DD>.html`** (สำเนาเดียวกัน) ไปกับ draft ด้วย เพราะเมื่อเปิดไฟล์แนบในเบราว์เซอร์ ลิงก์จะเป็น URL ต้นฉบับสะอาด **ไม่ถูก Gmail ห่อด้วย `google.com/url`** → คลิกเข้าหน้าข่าวตรงทันที (ทางออกของข้อจำกัด Gmail ที่ห่อลิงก์ทุกอันในตัวอีเมล) |
